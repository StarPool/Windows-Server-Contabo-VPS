...
#Windows 10 JP
wget -O win10_jp.iso --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36" https://bit.ly/49qp1gl
#windows2019_jp
...
mount -o loop win10_jp.iso winfile
